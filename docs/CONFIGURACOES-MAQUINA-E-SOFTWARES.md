...
- pnpm 11 ou superior
- Git
- PostgreSQL 15 ou superior, se for rodar o banco localmente sem Docker
...
- Se você usar Docker, o projeto já sobe frontend, backend e banco com os arquivos de compose do repositório.
